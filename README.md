...
К дз с room, добавить rxJava. <br/>


### HW-50

Посчитать сколько слов с четным количеством букв в тексте. <br/>


### HW-51

Создать страницу, на которой изображена картинка светофора. Соответственно через определенный промежуток <br/>
времени загорается красный, потом желтый, и зеленый. Для каждого цвета, рядом с картинкой необходимо вывести <br/>
соответствующие рекомендации: стойте, ждите, идите. <br/>
...
Retrofit + OkHttp <br/>
Показывать в recyclerView список репозиториев с github <br/>
...
api- https://breakingbadapi.com/api/episodes <br/>

Апишка возвращает список эпизодов сериала Во все тяжкие. <br/>
Необходимо десериализовать данные с json и отобразить серии в recyclerView <br/>


### HW-58

В продолжение к дз-57. <br/>
По клику на итем показывать детали эпизода. <br/>


### HW-59

В продолжение к дз-57. <br/>
Добавить room - при скролле вверх - обновлять итемы - показывать лоудер - делать запрос в апи. <br/>
