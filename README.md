...
1й экран - Экран авторизации. 2й экран - Главный экран <br/>
* На первом экране расположены поля ввода логина и пароля. <br/>
** Зашить данные юзера (логин и пароль) в приложение. <br/>
** Если данные введены не верно, показывать сообщение об ошибке. <br/>
